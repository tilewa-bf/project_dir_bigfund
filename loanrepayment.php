...
<head>
        ...
        <meta charset="utf-8" />
        <title>Geexsmith | Loan Repayment Status </title>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            if($_SERVER["REQUEST_METHOD"]=="POST"){
                                                  if(isset($_POST['submit'])){
                                                    ...
                                                    $sql = "SELECT member_id,member_name, group_name,loan_code, account_officer,approved_amount, total_payable as tp, SUM(repayment_amount) as rep, SUM(reverseamount), total_payable - (SUM(repayment_amount)-SUM(reverseamount)) as balance FROM rep_tbl WHERE status!='pending' AND tenor='$savtype' AND group_name='$groupname' GROUP BY loan_code HAVING balance <>0;";
                                            ...
                                            <tr>
                                                ...
                                                <td style="font-weight: bold;font-size: 14px;"><?php echo $wkr; ?></td>
