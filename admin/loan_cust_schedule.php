                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-sm-0 font-size-18">Loan Schedule</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Loan Schedule</h4>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="btn btn-info" href="loan_schedule.php?lid=<?php echo $rows['loan_code'];?>">Generate Schedule</a></td>
                                            </tr>
                                        <?php $i++; }
                                                ?>
                                            </tbody>
