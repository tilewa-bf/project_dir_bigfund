...
<head>
    <meta charset="utf-8" />
        <title>Demiral Empowerment | Loan Accounts Report</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Loan Accounts Reports</h4><br/>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            $sql ="SELECT p.loan_code,p.member_name,t.date_granted,t.expiry_date,p.loan_amount,p.compulsory_sav,p.total_payable, SUM(p.repayment_amount) AS totalPaid, p.total_payable-SUM(p.repayment_amount) as Balance FROM repayment_tbl AS p INNER JOIN loan_request AS t ON p.loan_code = t.loan_code GROUP BY loan_code";
                                            $result2 = mysqli_query($conn,$sql);
                                            while($rows = mysqli_fetch_assoc($result2)){
                                                $loancode = $rows['loan_code'];
                                                $membername = $rows['member_name'];
                                                $gdate = $rows['date_granted'];
                                                $dbexdate = $rows['expiry_date'];
                                                $td = date('Y-m-d');
                                                ...
                                                $compsav = $rows['compulsory_sav'];
                                                $totalpayable = $loanamount + $compsav;
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $compsav;?></td>
                                                <td><?php echo $totalpayable;?></td>
                                                <td><?php echo $totalPaid;?></td>
                                                <td><?php echo $balance;?></td>
                                                <td><span class="badge bg-<?php echo $badge;?>"><?php echo $loanstatus;?></span></td>
