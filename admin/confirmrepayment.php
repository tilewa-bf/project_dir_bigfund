...
<head>
    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">LOAN REPAYMENT CONFIRMATION</h4>
                                    <!--
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                <?php
                                                    $i=1;
                                                    $sql ="SELECT * FROM rep_tbl WHERE loan_code NOT LIKE '%100219%' AND member_name NOT LIKE '%Loan Account%' AND status='pending' AND status2!='deleted'";
        ...
        <script>
            ...
            window.location.href='confirmloanrepayment.php?confirmrepayment='+id;
            }
            }
        </script>
