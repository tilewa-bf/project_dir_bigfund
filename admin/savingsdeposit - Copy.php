                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-sm-0 font-size-18">MEMBER SAVINGS DEPOSIT</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Savings Deposit</h4>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                if($_SERVER["REQUEST_METHOD"]=="POST"){
                                                  if(isset($_POST['submit'])){
                                                    ...
                                                    $sql = "SELECT * FROM member where status='undelete' AND status2!='Inactive' AND savings_type='$savtype' ORDER BY id";
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $rows['reg_date']; ?></td>
                                                 <td><a class="btn btn-info" href="membersavings.php?mid=<?php echo $rows['member_id'];?>&st=<?php echo $savtype;?>">Make Deposit</a></td>
                                            </tr>
