                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title" style="margin-top:30px;margin-bottom: -20px;">Repayment Details</h4><br/>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            $balance = 0;
                                                    ...
                                                    $sql ="SELECT * FROM rep_tbl WHERE status!='pending' AND loan_code NOT LIKE '%100129%' AND credit IS NOT NULL AND credit !='0' AND creation_date BETWEEN '$id2' AND '$id3' AND account_officer='$id1' ORDER BY rp_id DESC";
