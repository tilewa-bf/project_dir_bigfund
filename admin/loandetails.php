...
<head>
        ...
        <meta charset="utf-8" />
        <title>Bigfund | Loan History</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <ul class="breadcrumb">
                                        <li><a href="loan_history_admin.php">Loan Group</a></li>
                                        <li>Loan History</li>
                                    </ul>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <label for="formrow-group-input" class="form-label"><strong>Principal Approved Amount:</strong> &#8358;<?php if(isset($dbloanapprovedamount)){echo number_format($dbloanapprovedamount);}?> </label><br/>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <label for="formrow-group-input" class="form-label"><strong>Principal + Interest:</strong> &#8358;<?php if(isset($dbloanpi)){ echo number_format($dbloanpi);}?> </label><br/>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            $i = 1;
                                            $balance = 0;
                                            $sql ="SELECT * FROM `rep_tbl` WHERE loan_code='$lid' AND status!='pending' AND status2!='deleted' ORDER BY rp_id ASC";
                                            $result2 = mysqli_query($conn,$sql);
                                            while($rows = mysqli_fetch_assoc($result2)){
                                                 $loancode = $rows['loan_code'];
                                                  $transid = $rows['trans_id'];
                                                 $transdate = $rows['creation_date'];
                                                 $membername = $rows['member_name'];
                                                 $debit = $rows['debit'];
                                                 $revamt = $rows['reverseamount'];
                                                 $credit = $rows['repayment_amount'];
                                            ...
                                            <tr>
                                                ...
                                                <td style="color: red;font-weight:bold;"><?php echo number_format($debit,2);?></td>
                                                <td style="color: green;font-weight:bold;"><?php echo number_format($credit,2);?></td>
