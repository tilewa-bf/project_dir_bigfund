...
<head>
        ...
        <meta charset="utf-8" />
        <title>Bigfund | Customer Savings Withdrawal </title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-sm-0 font-size-18">MEMBER SAVINGS WITHDRAWAL</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Savings Withdrawal</h4>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo strtoupper($rows['account_officer']); ?></td>
                                                 <td><a class="btn btn-info" href="membersavings2.php?mid=<?php echo $rows['account_number'];?>&st=<?php echo $savtype;?>">Make Withdrawal</a></td>
                                            </tr>
