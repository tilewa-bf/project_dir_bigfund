...
<head>
        ...
        <meta charset="utf-8" />
        <title>Bigfund | Loan Repayment </title>
    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="acctype" id="formrow-inputState" class="form-select" onchange="showMember(this.value)" required>
                                                            ...
                                                            <?php 
                                                            $sql ="SELECT * FROM group_tbl WHERE status='Active' AND account_officer='$dbname'";
        ...
        function showMember(str) {
          if (str == "") {
            ...
            xmlhttp.open("GET","getloanrepaymentmember_admin.php?q="+str,true);
            xmlhttp.send();
          }
        }
        </script>
