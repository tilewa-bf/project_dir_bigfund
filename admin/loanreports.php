...
<head>
        ...
        <meta charset="utf-8" />
        <title>Bigfund | Loan Report </title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-sm-0 font-size-18">Loan Reports</h4>
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                ...
                                                <h5 class="mb-0">View Approved/Pending Loan Request</h5>
                                            </div>
                                ...
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                                                <h5 class="mb-0">Loan By Group Name</h5>
                                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="loanbybalance.php" target="_blank">  
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                                                <h5 class="mb-0">Loan By Balance</h5>
                                            </div>
