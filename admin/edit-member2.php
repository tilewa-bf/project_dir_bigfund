...
<head>
        ...
        <meta charset="utf-8" />
        <title>Bigfund | Edit member </title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                $i=1;
                                                    $sql = "SELECT * FROM member where status='undelete' AND group_name='$groupname' ORDER BY group_name";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info" href="editmem.php?mid=<?php echo $rows['id'];?>">Edit</a>
                                                </td>
                                            </tr>
