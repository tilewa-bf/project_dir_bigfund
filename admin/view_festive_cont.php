...
<head>
        ...
        <meta charset="utf-8" />
        <title>Geexsmith | Edit Festive Member </title>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div style="margin-top: 20px;" class="row">
                                                <div class="col-xl-3">
                                                    <select name="fullname" id="formrow-inputState" class="form-select" required>
                                                                ...
                                                                <?php 
                                                                $sql ="SELECT * FROM staff_tbl WHERE status='undelete' AND status2='Active' AND lastname!='Admin'";
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                $i=1;
                                                    $sql = "SELECT *, SUM(monthly_price) as mp FROM festive_pay_tbl where status='PAID' AND status2='undelete' AND account_officer='$fullname' GROUP BY fullname ORDER BY fepa_id";
                                            ...
                                            <tr>
                                                ...
                                                <td><strong><?php echo number_format($rows['mp'],2); ?></strong></td>
                                            </tr>
