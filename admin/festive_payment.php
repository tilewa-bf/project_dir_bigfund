...
<head>
        ...
        <meta charset="utf-8" />
        <title>Geexsmith | Festive Payment </title>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            if($_SERVER["REQUEST_METHOD"]=="POST"){
                                                  if(isset($_POST['submit'])){
                                                    ...
                                                    $sql = "SELECT member_id,member_name, group_name,loan_code, account_officer, total_payable as tp, SUM(repayment_amount) as rep, SUM(reverseamount), total_payable - (SUM(repayment_amount)-SUM(reverseamount)) as balance FROM rep_tbl WHERE group_name='$groupname' AND status!='pending' GROUP BY loan_code HAVING balance <>0;";
