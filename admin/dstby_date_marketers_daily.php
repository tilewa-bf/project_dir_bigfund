                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            if($_SERVER["REQUEST_METHOD"]=="POST"){
                                                  if(isset($_POST['submit'])){
                                                    ...
                                                    $sql ="SELECT * FROM deposit_savings_tbl WHERE savings_type='DAILY' AND trans_date BETWEEN '$from' AND '$to' AND entry_type='credit' AND trans_type='CD' AND account_officer='$accountoff' AND account_number NOT LIKE '%100467%'AND status!='Processing' AND status2!='delete' ORDER BY mem_id DESC";
