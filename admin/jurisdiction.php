...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    if(isset($_POST['submit'])){
        ...
        $sql = "SELECT * FROM jurisdiction WHERE zone='".$zone."'";   
        ...
        if($numrows > 0){
            $alerttype= "danger";
            $icon = "block-helper";
            $msg = "Zone existed before!";
        }else{
            $sql2 = "INSERT INTO jurisdiction(jur_id,country,state,lga,zone,status,created_by,creation_date,update_by,update_dt,status2)VALUES(NULL,'Nigeria','$state','$lga','$zone','Inactive','$dbname','$date',NULL,NULL,'undelete')";
...
<head>
        ...
        <meta charset="utf-8" />
        <title>Bigfund | Jurisdiction Creation </title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-sm-0 font-size-18">Jurisdiction Creation</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">JURISDICTION CREATION</h4>
                                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label for="formrow-state-input" class="form-label">State</label>
                                                        <input type="text" name="state" class="form-control" id="formrow-state-input" placeholder="Enter State" required>
                                                    </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label for="formrow-lga-input" class="form-label">LGA</label>
                                                        <input type="text" name="lga" class="form-control" id="formrow-lga-input" placeholder="Enter LGA" required>
                                                    </div>
                                                </div>  
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label for="formrow-firstname-input" class="form-label">ZONE</label>
                                                        <input type="text" name="zone" class="form-control" id="formrow-firstname-input" placeholder="Enter Zone" required>
                                                    </div>
                                                </div>
                                                <!-- <div class="col-md-4">
                                                    <div class="mb-3">
