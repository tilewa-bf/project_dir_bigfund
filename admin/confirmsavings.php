                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-sm-0 font-size-18"> SAVINGS DEPOSIT CONFIRMAION</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Savings Deposit Confirmation</h4>
                                        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                            <div style="margin-top: 20px;" class="row">
                                                <div class="col-xl-3">
                                                    <select name="savtype" id="formrow-inputsavtype" class="form-select" required>
                                                                ...
                                                                ?>
                                                                <!-- <?php 
                                                                $sql ="SELECT * FROM group_tbl WHERE status='Active' ORDER BY group_name ASC";
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                if($_SERVER["REQUEST_METHOD"]=="POST"){
                                                  if(isset($_POST['submit'])){
                                                    ...
                                                    $sql ="SELECT *, SUM(credit) as deposit, SUM(debit) as wtd FROM deposit_savings_tbl WHERE account_number NOT LIKE '%100467%' AND account_number NOT LIKE '%100403%'AND account_number NOT LIKE '%100999%' AND account_number NOT LIKE '%100943%' AND account_number NOT LIKE '%100230%' AND cust_name NOT LIKE '%Savings Deposit%' AND cust_name NOT LIKE '%Fixed Savings%' AND cust_name NOT LIKE '%Daily Savings Deposit%' AND status='Processing' AND savings_type='$savtype' AND status2!='delete' GROUP BY post_by";
                                            ...
                                            <tr>
                                                    ...
                                                    <td>     
                                                        <!-- <a class='btn btn-success' href="confirmmembersavings.php?confirmsavings=<?php echo $postby; ?>">Confirm</a> -->
                                                        <a class="btn btn-info" href="confirmmemsaving.php?pb=<?php echo $postby; ?>&en=credit&type=<?php echo $savtype;?>">Details</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                    <td><?php echo $i; ?></td>
                                                    ...
                                                    <td>
                                                        <!-- <a class="btn btn-success" href="confirmmembersavings.php?confirmsavings=<?php echo $postby; ?>">Confirm</a> -->
                                                        <a class="btn btn-info" href="confirmmemsaving.php?pb=<?php echo $postby; ?>&en=debit&type=<?php echo $savtype;?>">Details</a>   </td>
                                            </tr>
