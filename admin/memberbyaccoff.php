                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            if($_SERVER["REQUEST_METHOD"]=="POST"){
                                                  if(isset($_POST['submit'])){
                                                    ...
                                                    $sql2 ="SELECT `member_id`, `surname`, `firstname`, `othername`, `phone`, `email`, `gender`, `group_name`, `reg_fee`, `account_officer`,`reg_date` FROM `member` WHERE account_officer='$fullname'";
