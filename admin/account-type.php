...
if($_SERVER["REQUEST_METHOD"]=='POST'){
    if(isset($_POST['submit'])){
        if($_POST['acctype']=='Choose Account Type'){
            ...
            $alerttype = "danger";
        }elseif($_POST['acctype']=='DAILY SAVINGS'){
            $acctype = test_input($_POST['acctype']);
            header("Location: dailysavings-account.php?acctype=$acctype");
        }elseif($_POST['acctype']=='SAVINGS'){
            $acctype = test_input($_POST['acctype']);
            header("Location:savings-account.php?acctype=$acctype");
        }elseif($_POST['acctype']=='FIXED SAVINGS'){
            $acctype = test_input($_POST['acctype']);
            header("Location:fixed-savings.php?acctype=$acctype");
        }
    }
}
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-sm-0 font-size-18">Select Account Type</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Select Account Type</h4>
                                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        <label for="formrow-inputState" class="form-label">Type of Account</label>
                                                        <select name="acctype" id="formrow-inputState" class="form-select">
                                            ...
                                            <div>
                                                <button type="submit" name="submit" class="btn btn-primary waves-effect waves-light">Fill Form</button>
                                            </div>
                                        </form>
