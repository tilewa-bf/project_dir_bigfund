...
$savtype=$surname=$firstname=$othername=$pno=$occupation=$dob=$email=$gender=$groupname=$mid=$nin=$bvn=$regfee=$accoff=$resadd=$busadd=$savamount=$state=$nok_name=$nok_pno=$relationship=$nok_address=$qualification=$regdate=$upd="";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  if(isset($_POST['submit'])){
        ...
        $memberid = "1".rand(0,9).rand(0,9).rand(0,9).rand(0,9).rand(0,9).rand(0,9).rand(0,9).rand(0,9).rand(0,9);
        $regdate = date("Y-m-d");
       ...
       /*Member Details*/
        ...
        $occupation = strtoupper(test_input($_POST['occupation']));
        ...
        //     $errors = "Savings Amount is empty";
        // }else{
        ...
        if(isset($errors)){
            ...
            $sql= "INSERT INTO member(id,savings_type,member_id,surname,firstname,othername,phone,occupation,date_of_birth,email,gender,mid,midno,bvn,picture,account_officer,res_address,bus_address,state,country,kin_name,kin_phone,relationship,kin_address,reg_date,upd,created_by,updated_by,status,status2) 
            VALUES (null,'$savtype','$memberid','$surname','$firstname','$othername','$pno','$occupation','$dob','$email','$gender','$mid','$nin','$bvn',NULL,'$accoff','$resadd','$busadd','$state','Nigeria','$nok_name','$nok_pno','$relationship','$nok_address','$regdate',null,'$dbname',NULL,'undelete','Inactive')";
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-sm-0 font-size-18">Member Account Creation (<?php echo $acctype;?>)</h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form autocomplete="off" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        <label>Savings Type <span style="color:red;" title="This field is required!">*</span></label>
                                                        <select name="savtype" value="<?php echo $savtype;?>" class="form-select">
                                                            <option selected>Choose Savings Type</option>
                                                            
                                                                <option selected value="<?php echo $acctype; ?>"><?php echo $acctype; ?></option>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        <label for="formrow-inputState" class="form-label">Gender <span style="color:red;" title="This field is required!">*</span></label>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        <label for="formrow-occupation-input" class="form-label">Occupation <span style="color:red;" title="This field is required!">*</span></label>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        <label for="formrow-inputaccountofficer" class="form-label">Account Officer <span style="color:red;" title="This field is required!">*</span></label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        <label for="formrow-state-input" class="form-label">State of Residence <span style="color:red;" title="This field is required!">*</span></label>
                                                        <input type="text" name="state" value="<?php echo $state;?>" class="form-control" id="formrow-state-input" placeholder="State" required="">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="formrow-residentialaddress-input" class="form-label">Residential Address <span style="color:red;" title="This field is required!">*</span></label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="formrow-businessaddress-input" class="form-label">Business Address <span style="color:red;" title="This field is required!">*</span></label>
                                            ...
                                            <div class="row">
                                                ...
                                                <!-- <div class="col-md-3">
                                                    <div class="mb-3">
                                                        <label for="formrow-nok-income-input" class="form-label">Savings Amount</label>
                                                        <input value="<?php echo $savamount;?>" type="text" name="savamount" class="form-control" id="input" placeholder="Enter Savings Amount" required>
                                                    </div>
                                                </div> -->
                                            </div>
                                            <hr></hr>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label for="formrow-nok-name-input" class="form-label">Next of Kin Name <span style="color:red;" title="This field is required!">*</span></label>
                                                        <input type="text" name="nok-name" value="<?php echo $nok_name;?>" class="form-control" id="formrow-nok-name-input" placeholder="Enter your Full name">
                                                    </div>
                                                </div>

                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label for="formrow-nok-pno-input" class="form-label">Next of Kin Phone Number <span style="color:red;" title="This field is required!">*</span></label>
                                                        <input type="text" name="nok-pno" value="<?php echo $nok_pno;?>" class="form-control" id="formrow-nok-pno-input" placeholder="Enter only numbers" maxlength="11">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="relationship" value="<?php echo $relationship;?>" class="form-control" id="formrow-relationship-input" placeholder="Enter relationship">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label for="formrow-nok-address-input" class="form-label">Next of Kin Address <span style="color:red;" title="This field is required!">*</span></label>
                                                        <input type="text" name="nok-address" value="<?php echo $nok_address;?>" class="form-control" id="formrow-nok-address-input" placeholder="Enter Address">
                                                    </div>
                                                </div>
                                                <!-- <div class="col-md-4">
                                                    <div class="mb-3">
