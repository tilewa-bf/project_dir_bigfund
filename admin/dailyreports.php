                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="member_list_daily.php" target="_blank">         
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="memberby_accoff_daily.php" target="_blank">         
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="memberbalance_daily.php" target="_blank">         
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="member_zero_balance_daily.php" target="_blank">         
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="member_regfee_daily.php" target="_blank">         
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="regfeebydate_daily.php" target="_blank">         
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="loanrequeststatus_daily.php" target="_blank">
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="pending-loan_daily.php" target="_blank">
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="decline-loan_daily.php" target="_blank">
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="activeloan_byaccofficer_daily.php" target="_blank">  
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="paidoffloan_byaccofficer_daily.php" target="_blank">  
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="loanbydate_daily.php" target="_blank">  
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="dailyremittance.php" target="_blank">  
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                                                <h5 class="mb-0">Expected Daily Loan Remittance</h5>
                                            </div>
                            ...
                            <!-- <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="daily_loan_sav_rem.php" target="_blank">  
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> --
                                                <h5 class="mb-0">Expected Daily Loan & Savings Remittance</h5>
                                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="loanrepbydate_daily.php" target="_blank">  
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="loanrepbydate_accoff_daily.php" target="_blank">  
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="loanbalancebyaccoff_daily.php" target="_blank">  
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="gloanbal_daily.php" target="_blank">  
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="viewloanaccount_daily.php" target="_blank">        
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="loanbyguarantor_daily.php" target="_blank">  
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                            ...
                            <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="marketers-report_daily.php" target="_blank">  
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
                                                <h5 class="mb-0">Marketers Customer Savings Summary Report</h5>
                                            </div>
                              ...
                              <div class="col-lg-3">
                                <div class="card mini-stats-wid">
                                    <div class="card-body">
                                        <a href="dstby_date_marketers_daily.php" target="_blank">  
                                        <div class="d-flex flex-wrap">
                                            <div class="me-3">
                                                <!-- <p class="text-muted mb-2"></p> -->
