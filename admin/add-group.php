...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    if(isset($_POST['submit'])){
        ...
        if($numrows > 0){
            $alerttype= "danger";
            $icon = "block-helper";
            $msg = "Group registered before!";
        }else{
            $sql2 = "INSERT INTO group_tbl(grp_id,group_name,leader_name,leader_number,account_officer,status,created_by,creation_date,updated_by,update_dt,status2)VALUES(NULL,'$groupname','$leadername','$leadernumber','$accoff','Inactive','$dbname',NOW(),NULL,NULL,'undelete')";
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-sm-0 font-size-18">Group Creation</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">GROUP CREATION</h4>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="groupname" class="form-control" id="formrow-groupname-input" placeholder="Enter Group" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="mb-3">
