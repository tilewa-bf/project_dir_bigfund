                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Loan Application</h4>
                                        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                            <div style="margin-top: 20px;" class="row">
                                                <div class="col-xl-3">
                                                    <select name="savings" id="formrow-inputState" class="form-select" required>
                                                                <option value="">Select Savings Type</option>
                                                                <?php 
                                                                $sql ="SELECT * FROM savings_type_tbl WHERE status='Active'";
                                                                $result= mysqli_query($conn,$sql);
                                                                while($rows = mysqli_fetch_assoc($result)){
                                                                ?>
                                                                <option value="<?php echo $rows['savings_name'];?>"><?php echo $rows['savings_name'];?></option>
                                                                <?php }
                                                                ?>     
                                                    </select>
                                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                if($_SERVER["REQUEST_METHOD"]=="POST"){
                                                    if(isset($_POST['submit'])){
                                                      $savtype = $_POST['savings'];

                                                         $sql = "SELECT * FROM member where status='undelete' AND status2='active' AND savings_type='$savtype' AND account_officer='$dbname' ORDER BY id";
