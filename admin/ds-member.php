                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                <?php
                                                $i=1;
                                                    $sql = "SELECT * FROM member where status='undelete'";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-info" href="edit-member.php?mid=<?php echo $rows['id'];?>">Edit</a>
                                                    <a class="btn btn-info" href="javascript:deletemember(<?php echo $rows['id'];?>)">Delete</a>
                                                </td>
                                            </tr>
