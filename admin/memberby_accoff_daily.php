                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title" style="margin-top:30px;margin-bottom: -20px;">Daily Member by Account Officer</h4><br/>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                $fullname = $_POST['fullname'];
                                                    ...
                                                    $sql = "SELECT * FROM member where savings_type='DAILY' AND status!='deleted' AND account_officer='$fullname' ORDER BY group_name";
