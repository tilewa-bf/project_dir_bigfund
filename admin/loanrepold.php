...
$memberid = $loancode = $dbloanmembername = $dbgroupname =$dbaccountofficer=$dbloanmemberid= $dbloancode= $dbloanpi = $dbloanappliedamount =$dbloanapprovedamount= $totalpayable =$dbloanapproveddate=$dbloanmaturitydate=$wkr=$noofweek=$dbloanbal="";

$loanmembersql = "SELECT loan_code,sum(debit) as debit,member_name,member_id,group_name,account_officer,tenor,applied_amount,approved_amount,approved_date,maturity_date,total_payable,SUM(repayment_amount) as tp, total_payable- SUM(repayment_amount) FROM rep_tbl WHERE loan_code = '$lid' AND status!='pending'";
...
if(mysqli_num_rows($loanmemberquery)==1){
    ...
    }elseif($dbloanapprovedamount>='0' && $dbloanapprovedamount<='100000'){
        $wkr = 5200;
        $noofweek  = $dbloanbal/$wkr;
    }
    ...
    $dbtotalPaid2 = $dbloanpi - $dbloanbal;
...
','Loan Account',NULL,NULL,'$tenor','$appliedamount','$approvedamount','$reverseamount','$totalpayable',NULL,'$credit','$debit',NULL,'pending','$narration',NULL,'$dbname',now(),'$dt',NULL,NULL,'undelete')";
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input style="font-weight: bold;" type="number" required="" name="totalpaid2" value="<?php echo $dbtotalPaid2;?>" class="form-control" id="formrow-contributionamount-input" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="mb-3">
