                                    ...
                                    <div class="card-body">
                                            ...
                                            <div style="margin-top: 20px;" class="row">
                                                <div class="col-xl-3">
                                                    <select name="groupname" id="formrow-inputState" class="form-select" required>
                                                                ...
                                                                <?php 
                                                                $sql ="SELECT * FROM group_tbl WHERE account_officer='$dbname' AND status='Active'";
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <?php
                                             ...
                                             $sql = "SELECT p.loan_code,p.member_name,t.approved_date,t.maturity_date,t.tenor,SUM(p.applied_amount) AS loanamount,p.approved_amount,p.total_payable,SUM(p.repayment_amount) AS totalPaid, p.total_payable-SUM(p.repayment_amount) as Balance FROM repayment_tbl AS p INNER JOIN loan_request AS t ON p.loan_code = t.loan_code WHERE p.group_name='$groupname' GROUP BY loan_code";
