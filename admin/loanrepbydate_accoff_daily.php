                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            if(isset($_POST['submit'])){
                                                    ...
                                                    $sql ="SELECT * FROM rep_tbl WHERE tenor='DAILY' AND status!='pending' AND loan_code NOT LIKE '%100129%' AND credit IS NOT NULL AND credit !='0' AND creation_date BETWEEN '$from' AND '$to' AND account_officer='$fullname' ORDER BY rp_id DESC";
