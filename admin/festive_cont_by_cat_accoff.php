...
<head>
    <meta charset="utf-8" />
        <title>Geexsmith | Festive Report by Category & Account Officer</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title" style="margin-top:30px;margin-bottom: -20px;">Member by Account Officer</h4><br/>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                $fullname = $_POST['fullname'];
                                                    ...
                                                    $sql = "SELECT * FROM member where status!='deleted' AND account_officer='$fullname' ORDER BY group_name";
