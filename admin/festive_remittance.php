...
<head>
        ...
        <meta charset="utf-8" />
        <title>Geexsmith | Festive Member Remittance </title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-sm-0 font-size-18"> FESTIVE MEMBERS REMITTANCE</h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                $i=1;
                                                    $sql = "SELECT * FROM festive where status='undelete' AND category='$category' ORDER BY category";
                                            ...
                                            <tr>
                                                ...
                                                <!-- <td>
                                                    <select id="category" name="category" id="category" class="form-select" required>
                                                ...
                                                <td><a class="btn btn-info" href="festive_pay.php?feid=<?php echo $rows['fe_id'];?>">Make Payment</a></td>
                                            </tr>
        ...
        <script src="assets/js/app.js"></script>
         ...
         <script>
            function makepayment(id){
                if(document.getElementById.value=="Choose Month"){
                    alert("Please Select Month!");
                }else{
                    if(confirm("Are you sure you want to Make payment for this member?")){
                    window.location.href = "makepayment.php?mp="+id;
                }
                }
            }
        </script>
