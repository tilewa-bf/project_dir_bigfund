                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title" style="margin-top:30px;margin-bottom: -20px;">Deposit Savings by Date</h4><br/>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            if($_SERVER["REQUEST_METHOD"]=="POST"){
                                                  if(isset($_POST['submit'])){
                                                    ...
                                                    $sql ="SELECT * FROM deposit_savings_tbl WHERE account_number NOT LIKE '%100467%' AND credit IS NOT NULL AND credit !='0' AND creation_date BETWEEN '$from' AND '$to' ORDER BY rp_id DESC";
