...
<head>
        ...
        <meta charset="utf-8" />
        <title>Bigfund | Edit Daily Savings </title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-sm-0 font-size-18">EDIT DAILY SAVINGS CUSTOMERS</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Select Account Officer</h4>
                                        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                            <div style="margin-top: 20px;" class="row">
                                                <div class="col-xl-3">
                                                    <select name="accoff" id="formrow-inputaccountofficer" class="form-select">
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                $accoff = $_POST['accoff'];
                                                $i=1;
                                                    $sql = "SELECT * FROM dailysaving where status='undelete' AND account_officer='$accoff' ORDER BY account_officer";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info" href="edit_ds.php?mid=<?php echo $rows['id'];?>">Edit</a>
                                                </td>
                                            </tr>
