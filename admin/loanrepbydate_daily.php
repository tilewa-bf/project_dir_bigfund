...
<head>
    <meta charset="utf-8" />
        <title>Bigfund | Loan Repayment by Date Report</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title" style="margin-top:30px;margin-bottom: -20px;">Loan Repayment by Date</h4><br/>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            if($_SERVER["REQUEST_METHOD"]=="POST"){
                                                  if(isset($_POST['submit'])){
                                                    ...
                                                    $sql ="SELECT * FROM rep_tbl WHERE tenor='DAILY' AND status!='pending' AND loan_code NOT LIKE '%100129%' AND credit IS NOT NULL AND credit !='0' AND creation_date BETWEEN '$from' AND '$to' ORDER BY rp_id DESC";
