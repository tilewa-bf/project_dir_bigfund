...
<head>
    <meta charset="utf-8" />
        <title>Bigfund | Loan By Guarantor Report</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title" style="margin-top:30px;margin-bottom: -20px;">Loan By Guarantor</h4><br/>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            $sql ="SELECT * FROM loan_request WHERE tenor='DAILY'";
                                            ...
                                            <tr>
                                                ...
                                                <td><strong><?php echo strtoupper($guarantorname);?></strong></td>
                                                <td><strong><?php echo ucwords($guarantorpno);?></strong></td>
