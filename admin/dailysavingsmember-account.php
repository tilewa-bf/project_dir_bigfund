...
$surname=$firstname=$othername=$pno=$occupation=$dob=$email=$gender=$groupname=$mid=$nin=$bvn=$regfee=$accoff=$resadd=$busadd=$state=$nok_name=$nok_pno=$relationship=$nok_address=$qualification=$regdate=$upd="";
  ...
  if(isset($_POST['submit'])){
       ...
       /*Member Details*/
        ...
        if(isset($errors)){
            ...
            $sql= "INSERT INTO dailysavingsmember_tbl(id,member_id,surname,firstname,othername,phone,occupation,date_of_birth,email,gender,group_name,mid,midno,bvn,reg_fee,picture,account_officer,res_address,bus_address,state,country,kin_name,kin_phone,relationship,kin_address,reg_date,upd,created_by,updated_by,status,status2) VALUES (null,'$memberid','$surname','$firstname','$othername','$pno','$occupation','$dob','$email','$gender','$groupname','$mid','$nin','$bvn','$regfee','$picture','$accoff','$resadd','$busadd','$state','Nigeria','$nok_name','$nok_pno','$relationship','$nok_address','$regdate','$upd','$dbname',NULL,'undelete','Inactive')";
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-sm-0 font-size-18">Member Account Creation (DAILY SAVINGS)</h4>
