                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="card-title" style="margin-top:30px;margin-bottom: -20px;">Expected Weekly Loan and Savings Remittance by Account Officer</h4><br/>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tr>
                                                ...
                                                <th>WEEKLY LOAN REP.</th>   
                                                <th>WEEKLY SAVINGS REP.</th>
                                                <th>TOTAL WEEKLY REP.</th>
                                            </tr>
                                            </thead>
                                            ...
                                            if($_SERVER["REQUEST_METHOD"]=="POST"){
                                                  if(isset($_POST['submit'])){
                                                    ...
                                                    $sql = "SELECT member_id,member_name, group_name,loan_code, account_officer,approved_amount, total_payable as tp, SUM(repayment_amount) as rep, SUM(reverseamount), total_payable - (SUM(repayment_amount)-SUM(reverseamount)) as balance FROM rep_tbl WHERE tenor='WEEKLY' AND status!='pending' AND account_officer='$fullname' GROUP BY loan_code HAVING balance <>0;";
                                                    $query = mysqli_query($conn,$sql);
                                                    while($rows = mysqli_fetch_assoc($query)){
                                                        $fullname=$rows['member_name'];
                                                        $approvedamount = $rows['approved_amount'];
                                                        if($approvedamount>='100001' && $approvedamount<='150000'){
                                                            $wkr = 7800;
                                                            $sar = 750;
                                                        }elseif($approvedamount>='0' && $approvedamount<='50000'){
                                                            $wkr = 2600;
                                                            $sar = 250;
                                                        }elseif($approvedamount>='50001' && $approvedamount<='100000'){
                                                            $wkr = 5200;
                                                            $sar = 500;
                                                        }
                                                        ...
                                                        elseif($approvedamount>='200001' && $approvedamount<='300000'){
                                                            $wkr = 15600;
                                                            $sar = 1500;
                                                        }
                                                        $remtotal=$remtotal+$wkr;
                                                        $savtotal=$savtotal+$sar;
                                                        $nettotal = $wkr+$sar;
                                                        $net=$net+$nettotal;
                                                ?>
                                            <tr>
                                                ...
                                                <td style="font-weight: bold;font-size: 14px;"><?php echo number_format($wkr,2); ?></td>
                                                <td style="font-weight: bold;font-size: 14px;"><?php echo number_format($sar,2); ?></td>
                                                <td style="font-weight: bold;font-size: 14px;"><?php echo number_format($nettotal,2); ?></td>
                                            </tr>
                                        <?php $i++; }}}
                                                ?>
                                            </tbody>
                                            <tfoot>
                                                ...
                                                <th style="font-weight: bold;font-size: 14px;"><?php echo number_format($savtotal,2);?></th>
                                                <th style="font-weight: bold;font-size: 14px;"><?php echo number_format($net,2);?></th>
                                            </tfoot>
                                        </table>
                                        </div>
