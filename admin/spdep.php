...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(isset($errors)){
        ...
        if($query2){
            ...
            //Insert into deposit_count2 table
            ...
            $sql3 = "INSERT INTO deposit_count2(id,passbook_id,date_paid,status)VALUES(NULL,'$passbookid','$date','paid') ";

            mysqli_query($conn,$sql3) or die($sql3);
            $n++;
        }while($n <= $nod);
