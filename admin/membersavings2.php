...
$surname=$firstname=$othername=$dbmembername= $dbmemberid = $dbaccountofficer =$dbloanmemberid= $dbloancode= $dbloanpi = $dbloanapprovedamount= $totalpayable= "";

// $membersql = "SELECT mem_id,savings_type,account_number,cust_name,account_officer,checked, SUM(COALESCE(CASE WHEN entry_type = 'credit'THEN amount END,0)) AS total_credits , SUM(COALESCE(CASE WHEN entry_type = 'debit' THEN amount END,0)) AS total_debits , SUM(COALESCE(CASE WHEN entry_type = 'credit' AND status='Confirmed' THEN amount END,0)) - SUM(COALESCE(CASE WHEN entry_type = 'debit' AND status='Confirmed' THEN amount END,0)) AS balance FROM deposit_savings_tbl WHERE account_number='$mid'";
$membersql = "SELECT mem_id,savings_type,account_number,cust_name,account_officer,checked, SUM(COALESCE(CASE WHEN entry_type = 'credit'THEN amount END,0)) AS total_credits , SUM(COALESCE(CASE WHEN entry_type = 'debit' THEN amount END,0)) AS total_debits , SUM(COALESCE(CASE WHEN entry_type = 'credit' AND status='Confirmed' THEN amount END,0)) - SUM(COALESCE(CASE WHEN entry_type = 'debit' AND status='Pending' THEN amount END,0)) AS balance FROM deposit_savings_tbl WHERE account_number='$mid'";
...
if(mysqli_num_rows($memberquery)==1){
    ...
    $dbid = $memberdata['mem_id'];
    $dbsavtype = $memberdata['savings_type'];
    $dbmemberid = $memberdata['account_number'];
    $dbmembername = $memberdata['cust_name']; 
    $dbaccountofficer = $memberdata['account_officer'];  
    $dbbalance = $memberdata['balance']; 
}
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    if(isset($_POST['addentry'])){
        ...
        if($amt > $balance){
            $errors = "Withdrawal Amount cannot be greater than your balance!";
            $alerttype = "danger";
        }
    ...
    if(isset($errors)){
        ...
        $sql = "INSERT INTO `deposit_savings_tbl`(`mem_id`,`savings_type`, `trans_id`, `account_number`, `cust_name`, `account_officer`,`debit`,`credit`, `amount`, `narration`,`ref_no`,`trans_type`, `entry_type`, `pay_type`, `status`, `status2`,`status3`, `post_by`, `confirm_by`,`confirm_dt`, `trans_date`, `date_time`) VALUES (NULL,'$savtype','$tid','$accountno','$name','$accountoff','$debit','$credit','$amt','$narration','NA','$transtype','$entrytype','Cash','Pending','undelete','unmove','$dbname',NULL,NULL,'$trans_date','$dt')";
        $query2 = mysqli_query($conn,$sql) or die($sql);

        //Insert the second leg into the depost_savings_tbl
        $sqldep = "INSERT INTO `deposit_savings_tbl`(`mem_id`,`savings_type`, `trans_id`, `account_number`, `cust_name`, `account_officer`,`debit`,`credit`, `amount`, `narration`,`ref_no`,`trans_type`, `entry_type`, `pay_type`, `status`, `status2`,`status3`, `post_by`, `confirm_by`,`confirm_dt`, `trans_date`, `date_time`) VALUES (NULL,'$savtype','$tid','$glaccno','Savings Deposit','$accountoff','$credit','$debit','$amt','$narration','NA','$transtype','$entrytype','Cash','Pending','undelete','unmove','$dbname',NULL,NULL,'$trans_date','$dt')";
...
if(isset($_POST['post'])){
    ...
    $sql = "UPDATE deposit_savings_tbl SET status = 'Processing' WHERE status='Pending' AND trans_type='CW' AND post_by='$dbname'"; 
            ...
            <div class="main-content">
                <div class="page-content">
                    ...
                    <?php if(isset($msg)){?><div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <?php if(isset($msg2)){?><div class="alert alert-success alert-dismissible fade show" role="alert">
                            <?php echo $msg2;?>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div> <?php } ?>
                    ...
                    <?php if(isset($msg3)){?><div class="alert alert-success alert-dismissible fade show" role="alert">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        ...
                                        <h4 class="mb-sm-0 font-size-18"><a href="savingswtd.php">Members / </a>Members Withdrawal</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Members Withdrawal</h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input hidden type="text" required name="savtype" value="<?php echo $st;?>" class="form-control" id="formrow-savtype-input" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        <label for="formrow-approveamount-input" class="form-label">Balance</label>
                                                        <input readonly type="text" name="balance" value="<?php echo $dbbalance;?>" class="form-control" id="input2">
                                                    </div>
                                                </div>
                                            ...
                                            <div hidden id="glaccount" class="col-lg-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea style="text-align:left;" class="form-control" name="narration">Withdrawal</textarea>
                                                    </div>
                                                </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="table-wrapper-scroll-y my-custom-scrollbar" id="trans">
                                                    <table id="trans" class="table table-striped table-bordered">
                                                        ...
                                                        <tbody style="overflow-y:scroll; height:100px;">                                     
                                                            ...
                                                            $total = 0;
                                                            $i = 1;
                                                            $sql = "SELECT * FROM deposit_savings_tbl WHERE status = 'Pending' AND post_by='$dbname' AND status2 = 'undelete' AND trans_type='CW' AND debit!=0 AND account_number NOT LIKE '%100467%' ORDER BY mem_id ASC ";
