...
<head>
    <meta charset="utf-8" />
    <title>Bigfund | Marketers Report</title>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title" style="margin-top:30px;margin-bottom: -20px;">Marketers Report</h4><br/>
                                ...
                                <tbody>
                                    ...
                                    if($_SERVER["REQUEST_METHOD"]=="POST"){
                                      if(isset($_POST['submit'])){
                                        ...
                                        $sql ="SELECT SUM(AMOUNT) AS marketerstotal,account_officer FROM dailysavingsmaster_tbl WHERE trans_date BETWEEN '$from' AND '$to' AND entry_type='credit' AND trans_type='CD' GROUP BY account_officer";
