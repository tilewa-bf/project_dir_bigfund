...
<head>
    <meta charset="utf-8" />
        <title>Bigfund | Daily Savings Income Report</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title" style="margin-top:30px;margin-bottom: -20px;">Daily Savings Income Report</h4><br/>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            if($_SERVER["REQUEST_METHOD"]=="POST"){
                                                  if(isset($_POST['submit'])){
                                                    ...
                                                    $sql = "SELECT * FROM income_tbl WHERE status2='undelete' AND status= 'Confirmed' AND trans_date BETWEEN '$from' AND '$to' AND credit!=0 AND account_no='100275' ORDER BY trans_date DESC";
