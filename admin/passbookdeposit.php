...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $tid = "TPD".rand(0,9).rand(0,9).rand(0,9).rand(0,9).rand(0,9).rand(0,9).rand(0,9).date('Y').date('m').date('d');
    ...
    if(isset($errors)){
        ...
        $sql = "INSERT INTO passbook_deposit(id,prd_type,trans_id,ref_no,entry_type,pay_type,member_id,passbook_id,member_name,amount,no_of_days,total,status,status2,status3,deposit_by,confirm_by,trans_date, date_time) VALUES (NULL,'Thriftpay','$tid','N/A','Deposit','Cash','$memberid','$passbookid','$name','$conamt','$nod','$total','0','Pending','undelete','$dbname',null,'$trans_date','$dt')";

        $query2 = mysqli_query($conn,$sql) or die($sql);
        if($query2){
            $msg = "Entry Added";

            $sql2 = "INSERT INTO deposit(id,prd_type,member_id,passbook_id,total_contribution,status,trans_date,date_time,deposit_by)VALUES(NULL,'Thriftpay','$memberid','$passbookid','$total','Processing','$trans_date','$dt','$dbname') ";
            mysqli_query($conn,$sql2) or die($sql2);

            //Querying the tbl_balance to get the previous balance and update it as well.
            $sql3 = "SELECT * FROM tbl_balance WHERE passbook_id='".$passbookid."'";
            $balres= mysqli_query($conn,$sql3) or die($sql3);
            $balrow = mysqli_fetch_assoc($balres);
            $prevbal = $balrow['prev_bal'];
            $newbal = $balrow['new_bal'];
            $newbalance = $total + $newbal;

            $sql4 = "UPDATE tbl_balance SET prev_bal='$newbal',new_bal='$newbalance' WHERE passbook_id='".$passbookid."'";
            mysqli_query($conn,$sql4) or die($sql4);
...
if(isset($_POST['post'])){
    ...
    $sql = "UPDATE passbook_deposit SET status2 = 'Processing',status = 1 WHERE status=0 AND deposit_by='$dbname'"; 
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4"> Passbook Deposit - Multiple Entries</h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="passbookid" value="<?php echo $passbookid;?>" class="form-control" id="formrow-memberid-input" placeholder="Enter your Passbook ID">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                        ...
                                        <div id="trans">
                                            ...
                                            $sql = "SELECT * FROM passbook_deposit WHERE status2 = 'Pending' AND deposit_by='".$dbname."'";
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th></th>
                                                    <th></th>
                                                    <th style="font-size:20px;" id="total"><?php echo $total;?></th>
                                                    <th></th>
