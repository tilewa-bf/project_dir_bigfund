...
<head>
        <meta charset="utf-8" />
        <title>Bigfund | Loan Group </title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Enter Member ID</h4>
                                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="mb-3">
                                                        <label for="formrow-inputState" class="form-label">Member ID</label>
                                                        <input type="text" name="nok-pno" onkeyup="showMember(this.value)" value="" class="form-control" id="formrow-nok-pno-input" placeholder="Enter member ID"required>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div>
