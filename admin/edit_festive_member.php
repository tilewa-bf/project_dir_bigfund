...
<head>
        ...
        <meta charset="utf-8" />
        <title>Bigfund | Edit Festive Member </title>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                ...
                                                $i=1;
                                                    $sql = "SELECT * FROM festive where status='undelete' AND category='$category' AND account_officer='$dbname' ORDER BY category";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-info" href="edit_festive_savings_account.php?mid=<?php echo $rows['fe_id'];?>">Edit</a>
                                                </td>
                                            </tr>
