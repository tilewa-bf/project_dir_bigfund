...
if(isset($_GET['pb'])){
    ...
    $sql = "UPDATE data_entry_tbl SET status = 'Confirmed', confirm_by='$dbname' WHERE status='Processing' AND status2!='delete' AND entry_type='Credit' AND post_by_id='$pb'"; 
    ...
    if($result){
        ...
        $sql3 = "UPDATE income_tbl SET status = 'Confirmed' WHERE status='Processing'"; 
