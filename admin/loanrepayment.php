                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            if($_SERVER["REQUEST_METHOD"]=="POST"){
                                                  if(isset($_POST['submit'])){
                                                    ...
                                                    $sql = "SELECT member_id,member_name, group_name,loan_code, account_officer, total_payable as tp, SUM(repayment_amount) as rep, SUM(reverseamount), total_payable - (SUM(repayment_amount)-SUM(reverseamount)) as balance FROM rep_tbl WHERE status!='pending' AND tenor='$tenor' AND loan_code NOT LIKE '%100129%' AND account_officer='$dbname' GROUP BY loan_code HAVING balance <>0";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    $status = $rows['status'];
                                                     if($status=='pending'){?>
                                                        <a class="btn btn-info" onclick="alert('Ooops! You have unconfirmed loan repayment');">Loan Repayment</a>
                                                    <?php }else{?>
