                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            $total = 0;
                                            $balance = 0;
                                                    $sql2 ="SELECT loan_code,member_id,tenor,member_name,applied_amount,approved_date,maturity_date,approved_amount,SUM(applied_amount) AS loanamount,account_officer,total_payable,SUM(repayment_amount) AS totalPaid,SUM(repayment_amount) as repamt,SUM(reverseamount) as revamt,applied_amount, total_payable FROM rep_tbl WHERE tenor='WEEKLY' AND status!='pending' AND loan_code NOT LIKE '%100129%' AND total_payable!=0 GROUP BY loan_code";
