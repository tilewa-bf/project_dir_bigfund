                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            if($_SERVER["REQUEST_METHOD"]=="POST"){
                                                  if(isset($_POST['submit'])){
                                                    ...
                                                    $sql ="SELECT * FROM rep_tbl WHERE loan_code NOT LIKE '%100129%' AND credit IS NOT NULL AND credit !='0' AND creation_date BETWEEN '$from' AND '$to' AND group_name='$groupname' ORDER BY rp_id DESC";
