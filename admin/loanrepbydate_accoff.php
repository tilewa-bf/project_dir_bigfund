...
<head>
    <meta charset="utf-8" />
        <title>Bigfund | Loan Rep. Date and Account Officer</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title" style="margin-top:30px;margin-bottom: -20px;">Loan Repayment by Date and Account Officer</h4><br/>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            if(isset($_POST['submit'])){
                                                    ...
                                                    $sql ="SELECT * FROM rep_tbl WHERE tenor='WEEKLY' AND status!='pending' AND loan_code NOT LIKE '%100129%' AND credit IS NOT NULL AND credit !='0' AND creation_date BETWEEN '$from' AND '$to' AND account_officer='$fullname' ORDER BY rp_id DESC";
