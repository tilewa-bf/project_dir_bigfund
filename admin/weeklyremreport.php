                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            if($_SERVER["REQUEST_METHOD"]=="POST"){
                                                  if(isset($_POST['submit'])){
                                                    ...
                                                    $sql2 ="SELECT * FROM `weekly_remittance` WHERE post_by='$fullname' AND status='confirmed' ORDER BY rem_id DESC";
                                        ...
                                        <?php $i++; }
                                            ...
                                            <tfoot>
                                                ...
                                                <th></th>
                                                <th>Total</th>
                                                <th style="font-weight: bold;"><?php echo number_format($total,2);?></th>  
                                            </tfoot>
                                        </table>
                                    </div>
                                    </div>
