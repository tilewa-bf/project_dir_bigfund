                                ...
                                <tbody>
                                    ...
                                    if($_SERVER["REQUEST_METHOD"]=="POST"){
                                      if(isset($_POST['submit'])){
                                        ...
                                        $sql ="SELECT SUM(AMOUNT) AS marketerstotal,account_officer FROM deposit_savings_tbl WHERE savings_type='DAILY' AND trans_date BETWEEN '$from' AND '$to' AND entry_type='credit' AND trans_type='CD' AND account_number NOT LIKE '%100467%' AND status!='Processing' AND status2!='delete' GROUP BY account_officer";
