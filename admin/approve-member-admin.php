    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">REGISTER MEMBERS</h4>
                                    <!--
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                <?php
                                                $i=1;
                                                    $sql = "SELECT * FROM member where status2='inactive' AND status!='deleted' ORDER BY group_name";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a id="<?php echo $userpermission;?>" class="btn btn-primary" href="javascript:approvemember(<?php echo $rows['id'];?>)">Approve</a>
                                                    <a id="<?php echo $userpermission;?>" class="btn btn-warning" href="javascript:deletemember(<?php echo $rows['id'];?>)">Decline</a>
                                                </td>
                                            </tr>
        ...
        <script>
            function  deletemember(id){
                if(confirm("Are you sure you want to decline member")){
