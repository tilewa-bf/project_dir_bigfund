                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input style="font-weight: bold;" type="number" required="" name="balance" value="<?php echo $dbloanbal2;?>" class="form-control" id="formrow-contributionamount-input" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="savamount" class="form-control" id="input2">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
