...
<head>
    <meta charset="utf-8" />
        <title>Bigfund | Daily Savings Transaction Report</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title" style="margin-top:30px;margin-bottom: -20px;">Daily Savings Transaction Report</h4><br/>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            if($_SERVER["REQUEST_METHOD"]=="POST"){
                                                  if(isset($_POST['submit'])){
                                                    ...
                                                    $sql ="SELECT * FROM deposit_savings_tbl WHERE trans_date BETWEEN '$from' AND '$to' AND entry_type='credit' AND trans_type='CD' AND account_number NOT LIKE '%100467%' AND status!='Processing' AND status2!='delete' ORDER BY mem_id DESC ";
