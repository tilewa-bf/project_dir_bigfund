...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  if(isset($_POST['submit'])){
        ...
        $custacc = rand(0,9).rand(0,9).rand(0,9).rand(0,9).rand(0,9).rand(0,9);
        // $regdate = date("Y-m-d");
       ...
       /*Member Details*/
        ...
        if(isset($errors)){
            ...
            $sql= "INSERT INTO dailysaving(cust_id,cust_acc,surname,firstname,othername,phonenumber,gender,account_officer,reg_date,upd,created_by,updated_by,status) VALUES (null,'$custacc','$surname','$firstname','$othername','$pno','$gender','$accoff','$regdate',NULL,'$dbname',NULL,'undelete')";
            ...
            if($query){
                $alerttype="success";
                $msg = "Registration Successful. The Customer Account is:"." ". $custacc;
            }else{
...
<head>
        ...
        <meta charset="utf-8" />
        <title>Bigfund | Demiral Daily Savings Account Creation </title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <h4 class="mb-sm-0 font-size-18">Daily Saving(DS) Account Creation</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Customer Data</h4>
