                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title" style="margin-top:30px;margin-bottom: -20px;">Loan Balance By Group</h4><br/>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            if($_SERVER["REQUEST_METHOD"]=="POST"){
                                                  if(isset($_POST['submit'])){
                                                    ...
                                                    $sql2 ="SELECT loan_code,member_id,member_name,applied_amount,approved_amount,SUM(applied_amount) AS loanamount,total_payable,SUM(repayment_amount) AS totalPaid,SUM(repayment_amount) as repamt,SUM(reverseamount) as revamt,applied_amount, total_payable FROM rep_tbl WHERE group_name='$groupname' AND status!='pending' AND loan_code NOT LIKE '%100129%' AND total_payable!=0 GROUP BY loan_code";
