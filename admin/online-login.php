...
<head>
        ...
        <style type="text/css">
            .bg-overlay{background-size:cover!important;background-repeat:no-repeat!important;background-position:center!important;}
    ...
    <body style="background:url(assets/images/bg-login.png)!important;">
