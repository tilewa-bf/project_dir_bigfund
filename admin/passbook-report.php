...
<head>
        ...
        <meta charset="utf-8" />
        <title>Savepay | Passbook Report</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Passbook Report</h4>
                                    <!--
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Passbook Report</h4><br/>
                                        ...
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            $sql ="SELECT * FROM passbook WHERE creation_date BETWEEN '".$from."' AND '".$to."'";
