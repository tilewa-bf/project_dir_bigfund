...
$sql = "INSERT INTO passbook(id,member_id,passbook_id,contribution,no_of_days,product_type,creation_date)VALUES(null,'$memberid','$pid','$contribution','$nod','$prdtype','$creation_date')";
    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="member-account.php" key="t-products">Add Member</a></li>
                                    <li><a href="viewmember.php" key="t-product-detail">View Member</a></li>
                                    <li><a href="passbook.php" key="t-orders">Create Passbook</a></li>
                                    <li><a href="passbook-deposit.php" key="t-customers">Passbook Deposit</a></li>
                                    <!--
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input onkeyup="showmember(this.value)" type="text" name="memberid" class="form-control" id="formrow-memberid-input" placeholder="Enter your Member ID" required>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label for="formrow-membername-input" class="form-label">Name/Passbook ID:<div id="membername"><label name="membername"></label></div></label>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        <label for="formrow-passbookid-input" class="form-label">Name:<div id="passbookid"><label name="passbookid"></label></div></label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" name="conamt" class="form-control" id="formrow-contributionamount-input" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="nod" id="formrow-noofdays" class="form-select">
                                            ...
                                            <div>
                                                <button type="submit" name="submit" class="btn btn-primary waves-effect waves-light">Make Deposit</button>
                                            </div>
                                        </form>
        ...
        <script>
            function showmember(str) {
              ...
              xhttp.open("GET", "getpassbookid.php?q="+str, true);
              xhttp.send();
            }
        </script>
