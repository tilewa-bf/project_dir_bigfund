                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <a href="" class="logo logo-light">
                                <span class="logo-sm">
                                    <img style="margin-top: 15px;" src="assets/images/logo.png" alt="logo" height="30">
                                </span>
                                <span class="logo-lg">
                                    <img style="margin-top: 15px;" src="assets/images/logo.png" alt="logo" height="30">
                                </span>
                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <span class="d-none d-xl-inline-block ms-1" key="t-henry">Member ID: <?php echo $memberid;?></span>
                        </div>
                        <!--
                        <div class="dropdown d-inline-block">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="savplan.php">
                                    <i class="bx bx-store"></i>
                                    <span key="t-ecommerce">Savings Plan</span>
                                </a>
                            ...
                            <li>
                                <a href="withdraw.php">
                                    <i class="bx bx-store"></i>
                                    <span key="t-ecommerce">Passbook Withdrawal</span>
                                </a>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="membershipfee.php" key="t-customers">Membership Fee</a></li>
                                    <li><a href="thriftplan.php" key="t-orders">Passbook Creation</a></li>
                                    <li><a href="pay.php" key="t-customers">Passbook Deposit</a>
                                    <li><a href="withdraw.php" key="t-customers">Passbook Withdraw</a>
                                    <li><a href="transhistory.php" key="t-customers">Transaction History</a>
                                    <!--
                                    <li><a href="" key="t-products">Passbook Creation</a></li>
                                    <li><a href="" key="t-product-detail">Passbook Deposit</a></li>
                                        <ul class="sub-menu" aria-expanded="true">
                            ...
                            <li>
                                <a href="transhistory.php">
                                    <i class="bx bx-store"></i>
                                    <span key="t-ecommerce">Transaction History</span>
                                </a>
                            ...
                            <li>
                                <a href="member-profile.php">
                                    ...
                                    <span key="t-ecommerce">Profile/Settings</span>
                                </a>
