                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">WELCOME TO GLOBAL MARKETS SAVINGS COMMUNITY</h4>
                            ...
                            <div style="margin-top: 50px;" class="col-md-4">
                                <div>
                                    <div class="btn-group btn-group-example mb-3" role="group">
                                        ...
                                        <a href="withdraw.php"></a><button type="button" class="btn btn-danger w-lg"><i class="mdi mdi-thumb-down"></i>Withdraw</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
