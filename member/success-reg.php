...
<head>
        ...
        <meta charset="utf-8" />
        <title>Success Page | Savepay</title>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="home-wrapper">
                            <div class="mb-5">
                                <a href="dashboard.savepay.ng/member/index.php" class="d-block auth-logo">
                                    <img src="assets/images/logo.png" alt="" height="20" class="auth-logo-dark mx-auto">
                                    <img src="assets/images/logo.png" alt="" height="20" class="auth-logo-light mx-auto">
                                </a>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-4">
                                    <div class="maintenance-img">
                                        <img src="assets/images/Registration-Successful.png" alt="" class="img-fluid mx-auto d-block">
                                    </div>
                                </div>
                            </div>
                            <?php if(isset($mid)){?><div class="alert alert-success" role="alert">
                                                <strong>Registration Successful.</strong> Your Member ID is: <?php echo $mid;?>. <a href="index.php" class="alert-link">Login here</a>. Check your email for Login details.
                                                </div>
                                                <?php
...
<!-- Mirrored from themesbrand.com/skote/layouts/pages-maintenance.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Mar 2021 14:30:19 GMT -->
</html>
