...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Dashboard | Thrift Pay - Dashboard</title>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <!--
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="member-personalinfo.php" key="t-orders">Personal Information</a></li>
                                    <li><a href="member-passbookdep.php" key="t-customers">Change Password</a>
                                    <li><a href="member-passbookdep.php" key="t-customers">Bank Information</a>
                                    <!--
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="pay.php" key="t-customers">Passbook Deposit</a>
                                    <!--
                                    <li><a href="" key="t-products">Passbook Creation</a></li>
                                    <li><a href="" key="t-product-detail">Passbook Deposit</a></li>
                                        <ul class="sub-menu" aria-expanded="true">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="pt-4">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <h5 class="font-size-15"><?php if(isset($passbookid)){
                                                                echo $passbookid;
                                                            }else{
                                                                echo "Missing!";
                                                            } ?></h5>
                                                            <p class="text-muted mb-0">Passbook ID</p>
                                                        </div>
                                                        <div class="col-6">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card mini-stats-wid">
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="media-body">
                                                        <p class="text-muted fw-medium">Thriftpay Total No. of Days</p>
                                                        <h4 class="mb-0"><?php if(isset($totalnod)){
                                                                echo $totalnod.' '.'days';
                                                            }else{
                                                                echo "0";
                                                            } ?></h4>
                                        ...
                                        <div class="table-responsive mt-4">
                                            <table class="table align-middle table-nowrap">
                                                <tbody>
                                                    <tr>
                                                        <td style="width: 30%">
                                                            <p class="mb-0">No. of days saved</p>
                                                        </td>
                                                        <td style="width: 25%">
                                                            <h5 class="mb-0"><?php if(isset($noofdays)){
                                                                echo $noofdays;
                                                            }else{
                                                                echo "0";
                                                            } ?></h5></td>
                                                        <td>
                                                            <div class="progress bg-transparent progress-sm">
                                                                <div class="progress-bar bg-primary rounded" role="progressbar" style="width: 5%" aria-valuenow="94" aria-valuemin="0" aria-valuemax="100"></div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h5 class="mb-0"><?php if(isset($remainingdays)){
                                                                echo $remainingdays;
                                                            }else{
                                                                echo "0";
                                                            } ?></h5>
...
<!-- Mirrored from themesbrand.com/skote/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Mar 2021 14:28:34 GMT -->
</html>